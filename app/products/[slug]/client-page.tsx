    ...
    <div className="pt-24 lg:pt-28 pb-20">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-8 lg:gap-12">
        <div className="lg:sticky lg:top-28 lg:self-start space-y-3">
          ...
          >
            <img src={images[activeImg]} alt={product.name} className={cn('w-full h-full object-cover transition-transform duration-500', zoom ? 'scale-150' : 'group-hover:scale-110')} />
