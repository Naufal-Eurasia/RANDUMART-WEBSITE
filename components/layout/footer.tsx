        ...
        <div className="col-span-2 lg:col-span-2">
          ...
          <div className="flex gap-2">
            <a
              ...
              className="grid place-items-center w-10 h-10 rounded-full bg-white shadow-soft text-brand-green hover:bg-brand-green hover:text-white transition-colors"
            >
